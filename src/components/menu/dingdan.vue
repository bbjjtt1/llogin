  ...
  <div>
    <el-container>
      <el-header class="header">
           <el-row :gutter="20">
            <el-col :span="8">
                  <el-input placeholder="请输入你要查找的id" v-model="userId" clearable @clear="getList()">
...
export default {
  methods: {
    //main
      ...
      //搜索管理员
      findUser(){
        this.$axios.get('api/usermanager/search/' + this.userId)
            .then(resp =>{
      ...
      if(!valid) return
      //发起修改用户的网络请求
      this.$axios.post('api/usermanager/orderchange/' + this.editForm.userId,{
